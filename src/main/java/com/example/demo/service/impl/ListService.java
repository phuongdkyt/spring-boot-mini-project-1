...
public class ListService implements IListService {
    ...
    public ResponseEntity<?> getMarkOnTotalQuestion(Integer testId) {
        ...
        try {
            ...
            if (!Common.isNullOrEmpty(scoreEssay)) {
                UserTestEntity userTestEntity = userTestRepository.findByTest_IdAndUser_Id(Common.getUserId(), testId);
                userTestEntity.setStatus_result(1);
